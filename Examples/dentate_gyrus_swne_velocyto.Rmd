...
```{r}
load("~/swne/Examples/dentate_gyrus.p2.velocyto.RData.gz")
```


Pull out counts matrix and overdispersed genes from the Pagoda2 object, and scale/normalize the counts
```{r}
norm.counts <- ScaleCounts(t(r$misc$rawCounts), batch = NULL, method = "log", adj.var = T)
