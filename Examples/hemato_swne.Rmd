...
Identify biologically relevant factors and embed key marker genes. See [Table S1](https://www.biorxiv.org/highwire/filestream/84916/field_highwire_adjunct_files/0/276261-1.xlsx) from the Cell Systems paper for how the factors were named and how key genes were selected.
```{r}
